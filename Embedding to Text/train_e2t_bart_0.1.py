...
model_path = './models/e2t_bart_0.1.pth'
...
# Model saved as './models/e2t_bart_0.1.pth'

# Testing the model with actual data:

# Sample 1:
# Actual title: The best of Paris Fashion Week: Menswear Spring/Summer 2025
# Generated title: This is the second time in three years that a woman has been arrested. The first time was in 2009.The second is in 2010. This time around, the police have arrested three people. And the third is 2012.This time

# Sample 2:
# Actual title: Sir David Attenborough: New portrait by Jonathan Yeo unveiled
# Generated title: As for the rest of us, well, let's just say that we're not sure what happened. We're just going to have to wait and see what happens. If anything, though, we should be able to find out.

# Sample 3:
# Actual title: Junk Kouture: Student reaches final of sustainable fashion competition
# Generated title: In other words, it's time to move on. As a result, I'm going to have to rethink my approach to the matter. I've got to remember that I have a lot of work to do. And I want to

# Sample 4:
# Actual title: 10 of the best TV shows of 2024 so far
# Generated title: This is the first time in a long time that a single person has ever held a position of power. The second time is when a person is being held hostage. This time around, however, the situation is different. There is no

# Sample 5:
# Actual title: A chicken recipe so good its origin is being fought in court
# Generated title: So far, so good. But then again, I'm not sure what to expect. After all, this is the first time I've ever been in a position to do so. So I guess I'll just have to wait and